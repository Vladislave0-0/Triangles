...
int main() {
  ...
  GLfloat vertices_for_triangle[] = {
    -0.5f, -0.5f, 0.0f, // Left  
     0.5f, -0.5f, 0.0f, // Right 
     0.0f,  0.5f, 0.0f  // Top  
  };

  GLfloat vertices_for_rectangle[] = {
    // Первый треугольник
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(vertices_for_triangle), vertices_for_triangle, GL_STATIC_DRAW);
